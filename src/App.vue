...
<div class="modal-overlay discords">
  <div class="modal _discord">
    ...
    <div>
        <div class="mb-3">
            <div class="banner" style="height:136px;width:340px;border-radius:2%;background:url('https://cdn.discordapp.com/banners/906634054311481364/d84b623dab1be14283f231ab0564a891.png?size=4096') center center no-repeat;background-size:contain;background-attachment:fixed;background-position:center;">
