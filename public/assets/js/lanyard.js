...
function update_presence() {
  ...
  if(netflix){
    ...
    <img draggable="false" id="activityImg" src="${replacedurl}" style="position:relative;float:left;margin-left:10px;width:90px;height:90px;object-fit:cover;" alt="app logo">
    <div class="mb-3 ml-4">
