...
fetch("https://discordapp.com/api/v6/invite/212?with_counts=true", {
    ...
    fetch("https://api.mishudev.xyz/v1/user/906634054311481364", {
        ...
        user = data
        document.querySelector('.banner').style.background = `${user.banner ? `url('https://cdn.discordapp.com/banners/${user.id}/${user.banner}?size=4096') center center no-repeat` : `${user.hexAccentColor}`}`;
