...
fetch("https://discordapp.com/api/v6/invite/3Ewhx9SHQ6?with_counts=true", {
        method: 'GET',
        headers: {
    ...
    fetch("https://api.mishudev.xyz/v1/user/906634054311481364", {
        ...
        user = data
        document.querySelector('.banner').style.background = `${user.banner !== null ? `url('https://cdn.discordapp.com/banners/${user.id}/${user.banner}?size=4096') center center no-repeat` : `${user.hexAccentColor}`}`;
